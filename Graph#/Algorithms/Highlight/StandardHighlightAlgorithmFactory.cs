...
namespace GraphSharp.Algorithms.Highlight
{
	...
	{
        private static readonly string[] highlightModes = { "Simple", "Dijkstra" };
			...
			IHighlightParameters parameters )
		{
			switch (highlightMode)
			{
                ...
                case "Dijkstra":
                    return new DijkstraHighlightAlgorithm<TVertex, TEdge, TGraph>(controller, parameters);
				default:
					return null;
			}
		}
		...
		public string GetHighlightMode( IHighlightAlgorithm<TVertex, TEdge, TGraph> algorithm )
		{
            if (algorithm is SimpleHighlightAlgorithm<TVertex, TEdge, TGraph>)
                return "Simple";
            else if (algorithm is DijkstraHighlightAlgorithm<TVertex, TEdge, TGraph>)
                return "Dijkstra";
