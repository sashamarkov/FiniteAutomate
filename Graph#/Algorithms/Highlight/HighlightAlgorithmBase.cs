...
namespace GraphSharp.Algorithms.Highlight
{
        ...
        where TParameters : class, IHighlightParameters
    {
        ...
        public abstract bool OnVertexHighlighting(TVertex vertex, ref List<TEdge> highlightEdges);
        public abstract bool OnVertexHighlightRemoving( TVertex vertex );
        public abstract bool OnEdgeHighlighting(TEdge edge, ref List<TEdge> highlightEdges);
