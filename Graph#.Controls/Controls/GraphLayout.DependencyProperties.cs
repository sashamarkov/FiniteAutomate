...
namespace GraphSharp.Controls
{
        ...
        where TGraph : class, IBidirectionalGraph<TVertex, TEdge>
    {
        ...
        public static readonly DependencyProperty HighlightEdgesProperty = DependencyProperty.Register("HighlightEdges",
                                                                                                     typeof(List<TEdge>),
                                                                                                     typeof(
                                                                                                         GraphLayout
                                                                                                         <TVertex, TEdge
        ...
        public void HighlightTriggerEventHandler(object sender, HighlightTriggeredEventArgs args)
        {
            ...
            List<TEdge> highlightEdges = null;
            ...
            if (args.OriginalSource is VertexControl)
            {
                ...
                if (args.IsPositiveTrigger)
                    HighlightAlgorithm.OnVertexHighlighting(vertex, ref highlightEdges);
                else
            ...
            else if (args.OriginalSource is EdgeControl)
            {
                ...
                try
                {
                    ...
                    if (args.IsPositiveTrigger)
                        HighlightAlgorithm.OnEdgeHighlighting(edge, ref highlightEdges);
                    else
        ...
        public List<TEdge> HighlightEdges
        {
            get { return (List<TEdge>)GetValue(HighlightEdgesProperty); }
            set { SetValue(HighlightEdgesProperty, value); }
        }
